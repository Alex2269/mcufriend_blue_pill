/*
 * mcufriend_blue_pill class inherits from Adafruit_GFX class and the Arduino Print class.
 * Any use of mcufriend_blue_pill class and examples is dependent on Adafruit and Arduino licenses
...
class mcufriend_blue_pill : public Adafruit_GFX {

	public:
//	mcufriend_blue_pill(int CS=A3, int RS=A2, int WR=A1, int RD=A0, int RST=A4); //shield wiring
	mcufriend_blue_pill(int CS=0, int RS=0, int WR=0, int RD=0, int _RST=0);  //dummy arguments 
